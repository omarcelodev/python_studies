# super() é uma função usada para chamar métodos de uma classe pai em uma classe filha.
...
class Guerreiro(Personagem):
    def atacar(self):
        base = super().atacar() # Chama o método atacar da classe pai
        return base + " com espada!"
